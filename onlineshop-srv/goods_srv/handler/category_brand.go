...
func (s *GoodsServer) CategoryBrandList(_ context.Context, req *proto.CategoryBrandFilterRequest) (*proto.CategoryBrandListResponse, error) {
...
func (s *GoodsServer) GetCategoryBrandList(_ context.Context, req *proto.CategoryInfoRequest) (*proto.BrandListResponse, error) {
...
func (s *GoodsServer) CreateCategoryBrand(_ context.Context, req *proto.CategoryBrandRequest) (*proto.CategoryBrandResponse, error) {
	var category model.Category
...
func (s *GoodsServer) DeleteCategoryBrand(_ context.Context, req *proto.CategoryBrandRequest) (*emptypb.Empty, error) {
...
func (s *GoodsServer) UpdateCategoryBrand(_ context.Context, req *proto.CategoryBrandRequest) (*emptypb.Empty, error) {
