...
import (
	...
	"onlineshop-srv/inventory_srv/handler"
	"onlineshop-srv/inventory_srv/initialize"
	"onlineshop-srv/inventory_srv/proto"
	"onlineshop-srv/inventory_srv/utils"
)
...
func main() {
	...
	lis, err := net.Listen("tcp", fmt.Sprintf("%s:%d", *IP, 50051))
	if err != nil {
