...
type PasswordCheckInfo struct {
	...
	PassWord          string `protobuf:"bytes,1,opt,name=passWord,proto3" json:"passWord,omitempty"`                   //传入的密码
	EncryptedPassword string `protobuf:"bytes,2,opt,name=encryptedPassword,proto3" json:"encryptedPassword,omitempty"` //加盐后的密码
}
...
type CheckResponse struct {
	...
	Success bool `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"` //验证密码是否成功
}
...
type PageInfo struct {
	...
	PSize uint32 `protobuf:"varint,2,opt,name=pSize,proto3" json:"pSize,omitempty"` //一页多少条数据
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x57, 0x6f, 0x72, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x57, 0x6f, 0x72, 0x64, 0x12, 0x2c, 0x0a, 0x11, 0x65, 0x6e,
